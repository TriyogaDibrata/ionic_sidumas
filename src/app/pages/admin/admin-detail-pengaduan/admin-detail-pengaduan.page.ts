...
@Component({
  selector: 'app-admin-detail-pengaduan',
  templateUrl: './admin-detail-pengaduan.page.html',
  styleUrls: ['./admin-detail-pengaduan.page.scss'],
})
export class AdminDetailPengaduanPage implements OnInit {
